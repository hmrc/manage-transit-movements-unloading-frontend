...
class RemoveAdditionalReferenceYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector
      ...
      .apply(form, mrn, arrivalId, additionalReferenceIndex, Some(insetText), mode)(fakeRequest, messages)

  override val prefix: String = "additionalReference.index.removeAdditionalReferenceYesNo"
  ...
  "when inset text undefined" - {
    val view = injector
      .instanceOf[RemoveAdditionalReferenceYesNoView]
      .apply(form, mrn, arrivalId, additionalReferenceIndex, None, mode)(fakeRequest, messages)
