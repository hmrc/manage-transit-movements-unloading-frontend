...
case class HouseConsignmentAdditionalReferenceNumberPage(houseConsignmentIndex: Index, additionalReferenceIndex: Index) extends QuestionPage[String, String] {
