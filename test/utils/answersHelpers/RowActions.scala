...
trait RowActions {
  ...
  val grossWeightAction: Some[Actions] = Some(
    Actions(
      ...
      List(
        ActionItem(
          "/manage-transit-movements/unloading/AB123/change-house-consignment/1/items/1/change-gross-weight",
          Text("Change"),
        ...
        ActionItem(
          "/manage-transit-movements/unloading/AB123/change-house-consignment/1/items/1/gross-weight/remove",
          Text("Remove"),
          Some("gross weight of item 1"),
          "",
  ...
  val cusCodeItemAction: Some[Actions] = Some(
    Actions(
      ...
      List(
        ActionItem(
          "/manage-transit-movements/unloading/AB123/change-house-consignment/1/items/1/change-cus-code",
          Text("Change"),
  ...
  val commodityCodeItemAction: Some[Actions] = Some(
    Actions(
      ...
      List(
        ActionItem(
          "/manage-transit-movements/unloading/AB123/change-house-consignment/1/items/1/change-commodity-code",
          Text("Change"),
        ...
        ActionItem(
          "/manage-transit-movements/unloading/AB123/change-house-consignment/1/items/1/commodity-code/remove",
          Text("Remove"),
          Some("commodity code for item 1"),
          "",
  ...
  val nomenclatureCodeItemAction: Some[Actions] = Some(
    Actions(
      ...
      List(
        ActionItem(
          "/manage-transit-movements/unloading/AB123/change-house-consignment/1/items/1/change-combined-nomenclature-code",
          Text("Change"),
        ...
        ActionItem(
          "/manage-transit-movements/unloading/AB123/change-house-consignment/1/items/1/combined-nomenclature-code/remove",
          Text("Remove"),
          Some("combined nomenclature code for item 1"),
          "",
