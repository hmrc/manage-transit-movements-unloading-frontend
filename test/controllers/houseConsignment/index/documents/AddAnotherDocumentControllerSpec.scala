...
class AddAnotherDocumentControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar with Generators {
  ...
  private val viewModel: AddAnotherHouseConsignmentDocumentViewModel = houseConsignmentDocumentAddAnotherDocumentViewModel.arbitrary.sample.value
  ...
  "AddAnotherDocumentController" - {
    ...
    "must return a Bad Request and errors" - {
      "when invalid data is submitted and max limit not reached" in {
        ...
        contentAsString(result) mustEqual
          view(boundForm, mrn, arrivalId, houseConsignmentIndex, notMaxedOutViewModel)(request, messages, frontendAppConfig).toString()
      }
    }
