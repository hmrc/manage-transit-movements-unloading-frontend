...
object IdentificationNumberViewModel {
  ...
  class IdentificationNumberViewModelProvider @Inject() extends ModeViewModelProvider {
    ...
    override val prefix = "houseConsignment.index.departureMeansOfTransport.identificationNumber"

    def apply(mode: Mode, houseConsignmentIndex: Index)(implicit message: Messages): IdentificationNumberViewModel =
