...
class AddNetWeightYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures {
  ...
  private lazy val addAdditionalInformationYesNoRoute =
    controllers.houseConsignment.index.items.routes.AddNetWeightYesNoController
  ...
  "AddNetWeightYesNoController" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val view = injector.instanceOf[AddNetWeightYesNoView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(AddNetWeightYesNoPage(houseConsignmentIndex, itemIndex), true)
