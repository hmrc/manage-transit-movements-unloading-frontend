...
class RemoveDepartureMeansOfTransportYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector
      ...
      .apply(form, mrn, arrivalId, mode, houseConsignmentIndex, transportMeansIndex, Some(insetText))(fakeRequest, messages)

  override val prefix: String = "houseConsignment.index.departureMeansOfTransport.removeDepartureMeansOfTransportYesNo"
  ...
  "when inset text undefined" - {
    val view = injector
      .instanceOf[RemoveDepartureMeansOfTransportYesNoView]
      .apply(form, mrn, arrivalId, mode, houseConsignmentIndex, transportMeansIndex, None)(fakeRequest, messages)
