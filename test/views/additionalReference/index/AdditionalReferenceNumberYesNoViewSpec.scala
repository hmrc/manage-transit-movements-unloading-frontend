...
class AdditionalReferenceNumberYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[AdditionalReferenceNumberYesNoView].apply(form, mrn, arrivalId, additionalReferenceIndex, NormalMode)(fakeRequest, messages)

  override val prefix: String = "additionalReference.index.additionalReferenceNumberYesNo"
