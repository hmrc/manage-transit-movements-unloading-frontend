...
class AddIdentificationNumberYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures {

  private val formProvider = new YesNoFormProvider()
  private val form         = formProvider("departureMeansOfTransport.addIdentificationNumberYesNo")
  private val mode         = NormalMode

  private lazy val addIdentificationNumberYesNoRoute =
    controllers.departureMeansOfTransport.routes.AddIdentificationNumberYesNoController.onPageLoad(arrivalId, index, mode).url
  ...
  "AddIdentificationNumberYesNo Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, addIdentificationNumberYesNoRoute)

      val result = route(app, request).value

      val view = injector.instanceOf[AddIdentificationNumberYesNoView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(AddIdentificationNumberYesNoPage(index), true)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request    = FakeRequest(POST, addIdentificationNumberYesNoRoute).withFormUrlEncodedBody(("value", ""))
