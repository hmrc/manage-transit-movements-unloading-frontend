...
class AdditionalReferenceTypeViewSpec extends InputSelectViewBehaviours[AdditionalReferenceType] {
  ...
  override val prefix: String = Gen
    .oneOf(
      "houseConsignment.index.additionalReference.additionalReferenceType.NormalMode",
      "houseConsignment.index.additionalReference.additionalReferenceType.CheckMode"
    )
    .sample
    .value
