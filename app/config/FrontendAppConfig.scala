...
class FrontendAppConfig @Inject() (configuration: Configuration) {
  ...
  lazy val maxSupportingDocumentsHouseConsignment: Int = configuration.get[Int]("limits.maxSupportingDocumentsHouseConsignment")
  lazy val maxTransportDocumentsHouseConsignment: Int  = configuration.get[Int]("limits.maxTransportDocumentsHouseConsignment")
