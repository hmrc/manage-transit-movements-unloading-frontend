...
case class GrossWeightPage(houseConsignmentIndex: Index, itemIndex: Index) extends DiscrepancyQuestionPage[BigDecimal, Option[GoodsMeasureType03], BigDecimal] {
