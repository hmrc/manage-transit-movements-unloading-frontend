...
class ItemsDocumentReferenceNumberFormProviderSpec extends StringFieldBehaviours {

  private val prefix               = "houseConsignment.index.items.document.referenceNumber"
  ...
  val form = new ItemsDocumentReferenceNumberFormProvider()(requiredKey)
