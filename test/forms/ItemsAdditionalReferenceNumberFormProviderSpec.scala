...
class ItemsAdditionalReferenceNumberFormProviderSpec extends SpecBase with AppWithDefaultMockFixtures with StringFieldBehaviours {

  private val prefix      = "houseConsignment.index.items.additionalReference.additionalReferenceNumber"
