...
class AddIdentificationYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with Generators {

  private val formProvider = new YesNoFormProvider()
  private val mode         = NormalMode
  private val prefix       = "departureMeansOfTransport.addIdentificationYesNo"
  ...
  "AddIdentificationYesNoControllerController" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val view = injector.instanceOf[AddIdentificationYesNoView]
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, addIdentificationYesNoRoute)
