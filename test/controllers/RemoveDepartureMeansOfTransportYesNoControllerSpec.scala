...
class RemoveDepartureMeansOfTransportYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with Generators {
  ...
  private val form         = formProvider("departureMeansOfTransport.index.removeDepartureMeansOfTransportYesNo")
    ...
    "must return OK and the correct view for a GET" in {
      ...
      forAll(arbitrary[TransportMeansIdentification], nonEmptyString) {
        (identifier, identificationNumber) =>
          ...
          val insetText = TransportMeans(identifier.description, Some(identificationNumber)).asString
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      forAll(arbitrary[TransportMeansIdentification], nonEmptyString) {
        (identifier, identificationNumber) =>
          ...
          val insetText = TransportMeans(identifier.description, Option(identificationNumber)).asString
