...
class CombinedNomenclatureCodeController @Inject() (
  ...
  viewModelProvider: CombinedNomenclatureCodeViewModelProvider
)(implicit ec: ExecutionContext)
    extends FrontendBaseController
    with I18nSupport {

  private def form(viewModel: CombinedNomenclatureCodeViewModel): Form[String] =
          ...
          .fold(
            ...
            value =>
              for {
                ...
                Redirect(navigator.nextPage(CombinedNomenclatureCodePage(houseConsignmentIndex, itemIndex), itemMode, request.userAnswers))
              }
          )
    }
