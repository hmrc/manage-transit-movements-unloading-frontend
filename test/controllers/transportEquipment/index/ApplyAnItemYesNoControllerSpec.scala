...
class ApplyAnItemYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures {
  ...
  "ApplyAnItemYesNoController" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val view = injector.instanceOf[ApplyAnItemYesNoView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(ApplyAnItemYesNoPage(index), true)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request    = FakeRequest(POST, applyAnItemYesNoRoute).withFormUrlEncodedBody(("value", ""))
