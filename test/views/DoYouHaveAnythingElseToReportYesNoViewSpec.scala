...
class DoYouHaveAnythingElseToReportYesNoViewSpec extends YesNoViewBehaviours {

  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector.instanceOf[DoYouHaveAnythingElseToReportYesNoView].apply(form, mrn, arrivalId, NormalMode)(fakeRequest, messages)
