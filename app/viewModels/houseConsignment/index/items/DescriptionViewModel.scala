...
case class DescriptionViewModel(
  heading: String,
  title: String,
  ...
  def onSubmit(): Call = routes.DescriptionController.onSubmit(
    arrivalId,
...
object DescriptionViewModel {
  ...
  class DescriptionViewModelProvider @Inject() extends ModeViewModelProvider {

    override val prefix = "houseConsignment.item.description"
    ...
    def apply(
      ...
      houseConsignmentIndex: Index,
      itemIndex: Index
    )(implicit message: Messages): DescriptionViewModel =
