...
import pages.{ChangesToReportPage, GrossWeightAmountPage, TotalNumberOfItemsPage, TotalNumberOfPackagesPage}
  ...
  "ItemsSection" - {
    "must display" - {
      ...
      "correct gross mass" in {
        val userAnswers      = emptyUserAnswers.setValue(GrossWeightAmountPage, "1000")
