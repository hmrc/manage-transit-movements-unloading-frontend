...
class RemoveDocumentYesNoViewSpec extends YesNoViewBehaviours with Generators {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector
      ...
      .apply(form, mrn, arrivalId, houseConsignmentIndex, documentIndex, mode, Some(insetText))(fakeRequest, messages)

  override val prefix: String = "houseConsignment.index.documents.removeDocumentYesNo"
  ...
  "when inset text undefined" - {
    val view = injector
      .instanceOf[RemoveDocumentYesNoView]
      .apply(form, mrn, arrivalId, houseConsignmentIndex, documentIndex, mode, None)(fakeRequest, messages)
