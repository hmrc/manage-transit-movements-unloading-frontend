...
case class CommodityCodeViewModel(
  heading: String,
  title: String,
...
object CommodityCodeViewModel {

  class CommodityCodeViewModelProvider @Inject() extends ModeViewModelProvider {

    override val prefix = "houseConsignment.commodityCode"
    ...
    def apply(
      ...
      houseConsignmentIndex: Index,
      itemIndex: Index
    )(implicit message: Messages): CommodityCodeViewModel =
      new CommodityCodeViewModel(
