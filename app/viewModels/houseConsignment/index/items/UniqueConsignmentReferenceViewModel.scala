...
case class UniqueConsignmentReferenceViewModel(
  heading: String,
  title: String,
  ...
  def onSubmit(): Call = routes.UniqueConsignmentReferenceController.onSubmit(
    arrivalId,
...
object UniqueConsignmentReferenceViewModel {
  ...
  class UniqueConsignmentReferenceViewModelProvider @Inject() extends ModeViewModelProvider {

    override val prefix = "houseConsignment.item.uniqueConsignmentReference"
    ...
    def apply(
      ...
      houseConsignmentIndex: Index,
      itemIndex: Index
    )(implicit message: Messages): UniqueConsignmentReferenceViewModel =
