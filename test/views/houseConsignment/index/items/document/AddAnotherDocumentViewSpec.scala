...
class AddAnotherDocumentViewSpec extends ListWithActionsViewBehaviours {
  ...
  def applyNoItemsView: HtmlFormat.Appendable =
    injector
      ...
      .apply(formProvider(noItemsViewModel), mrn, arrivalId, houseConsignmentIndex, itemIndex, noItemsViewModel)(fakeRequest, messages, frontendAppConfig)
  ...
  override def applyMaxedOutView: HtmlFormat.Appendable =
    injector
      .instanceOf[AddAnotherDocumentView]
      .apply(formProvider(maxedOutViewModel), mrn, arrivalId, houseConsignmentIndex, itemIndex, maxedOutViewModel)(fakeRequest, messages, frontendAppConfig)
