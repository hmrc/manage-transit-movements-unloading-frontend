...
case class AddAnotherDepartureMeansOfTransportPage(houseConsignmentIndex: Index) extends QuestionPage[Boolean] {

  override def path: JsPath = HouseConsignmentSection(houseConsignmentIndex).path \ toString

  override def toString: String = "addAnotherDepartureMeansOfTransport"
}
