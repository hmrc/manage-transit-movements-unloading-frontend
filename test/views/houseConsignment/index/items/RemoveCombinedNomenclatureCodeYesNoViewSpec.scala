...
class RemoveCombinedNomenclatureCodeYesNoViewSpec extends YesNoViewBehaviours with Generators {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector
      .instanceOf[RemoveCombinedNomenclatureCodeYesNoView]
      .apply(form, mrn, arrivalId, houseConsignmentIndex, itemIndex, mode, Some(insetText))(fakeRequest, messages)

  override val prefix: String = "houseConsignment.removeCombinedNomenclatureCodeYesNo"
