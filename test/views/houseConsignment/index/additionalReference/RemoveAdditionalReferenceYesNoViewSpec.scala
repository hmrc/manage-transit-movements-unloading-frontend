...
class RemoveAdditionalReferenceYesNoViewSpec extends YesNoViewBehaviours {
  ...
  override def applyView(form: Form[Boolean]): HtmlFormat.Appendable =
    injector
      ...
      .apply(form, mrn, arrivalId, mode, houseConsignmentIndex, additionalReferenceIndex, Some(insetText))(fakeRequest, messages)

  override val prefix: String = "houseConsignment.index.additionalReference.removeAdditionalReferenceYesNo"
  ...
  "when inset text undefined" - {
    val view = injector
      .instanceOf[RemoveAdditionalReferenceYesNoView]
      .apply(form, mrn, arrivalId, mode, houseConsignmentIndex, additionalReferenceIndex, None)(fakeRequest, messages)
