        ...
        s"when $page defined" in {
          forAll(arbitrary[DocumentType]) {
            value =>
              ...
              action.href mustBe "#"
              action.visuallyHiddenText.value mustBe "document type"
        ...
        s"when $page defined" in {
          forAll(Gen.alphaNumStr) {
            value =>
              ...
              action.content.value mustBe "Change"
              action.href mustBe "#"
              action.visuallyHiddenText.value mustBe "reference number"
        ...
        s"when $page defined" in {
          forAll(Gen.alphaNumStr) {
            value =>
              ...
              action.content.value mustBe "Change"
              action.href mustBe "#"
              action.visuallyHiddenText.value mustBe "additional information"
