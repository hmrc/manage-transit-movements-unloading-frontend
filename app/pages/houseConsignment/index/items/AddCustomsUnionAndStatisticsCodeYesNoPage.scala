...
case class AddCustomsUnionAndStatisticsCodeYesNoPage(houseConsignmentIndex: Index, itemIndex: Index) extends QuestionPage[Boolean, Boolean] {
  ...
  override def toString: String = "addCustomsUnionAndStatisticsCodeYesNo"

  override def cleanup(value: Option[Boolean], userAnswers: UserAnswers): Try[UserAnswers] =
    value match {
      case Some(false) => userAnswers.remove(CustomsUnionAndStatisticsCodePage(houseConsignmentIndex, itemIndex))
