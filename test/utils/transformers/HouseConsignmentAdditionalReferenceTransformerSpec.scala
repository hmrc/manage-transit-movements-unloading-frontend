...
class HouseConsignmentAdditionalReferenceTransformerSpec extends SpecBase with AppWithDefaultMockFixtures with ScalaCheckPropertyChecks with Generators {

  private val transformer: HouseConsignmentAdditionalReferenceTransformer = app.injector.instanceOf[HouseConsignmentAdditionalReferenceTransformer]
