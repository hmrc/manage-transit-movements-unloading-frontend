...
case class NetWeightViewModel(
  ...
  def onSubmit(): Call = routes.NetWeightController.onSubmit(
    arrivalId,
...
object NetWeightViewModel {

  class NetWeightViewModelProvider @Inject() extends ModeViewModelProvider {

    override val prefix = "netWeight"
    ...
    def apply(
      ...
      houseConsignmentIndex: Index,
      itemIndex: Index
    )(implicit message: Messages): NetWeightViewModel =
      new NetWeightViewModel(
