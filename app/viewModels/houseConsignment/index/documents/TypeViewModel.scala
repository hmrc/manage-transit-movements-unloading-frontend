...
import viewModels.houseConsignment.index.documents.TypeViewModel.typePrefix
...
object TypeViewModel {
  ...
  val typePrefix = "houseConsignment.index.document.type"

  class TypeViewModelProvider @Inject() extends ModeViewModelProvider {

    override val prefix: String = typePrefix

    def apply(mode: Mode, documents: HouseConsignmentLevelDocuments, houseConsignmentIndex: Index)(implicit
      messages: Messages
    ): TypeViewModel =
      new TypeViewModel(
